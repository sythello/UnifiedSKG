...
class TrainDataset(Dataset):
    def __init__(self, args, raw_datasets, cache_root):
        ...
        cache_path = os.path.join(cache_root, 'spider_train_rewritten_mixed_2.12.1.0t-2.29.0.0i.cache')
...
class DevDataset(Dataset):
    def __init__(self, args, raw_datasets, cache_root):
        ...
        cache_path = os.path.join(cache_root, 'spider_dev_rewritten_mixed_2.12.1.0t-2.29.0.0i.cache')
        if os.path.exists(cache_path) and args.dataset.use_cache:
            self.extended_data = torch.load(cache_path)
        else:
            self.extended_data = []
