...
"""PyTorch OpenAI GPT-2 model with prefix-tuning (YS: In progress)."""
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        use_cache=False,
        output_attentions=False,
        prefix=None,    # YS added; prefix is only for SA, not considering XA for now
    ):
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            # YS: copied from uskg; use the decoder pfx here
...
class GPT2LMHeadModel(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        transformer_outputs = self.transformer(
            ...
            past_prompt=past_prompt,   # YS added
        )
