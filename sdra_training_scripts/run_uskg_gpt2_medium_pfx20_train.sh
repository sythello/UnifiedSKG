...
python train.py \
--seed 2 \
--cfg Salesforce/A-GPT2_medium_prefix_spider_with_cell_value-pfx=20.cfg \
--run_name $RUN_NAME \
...
## Back-up Args
# bs = 2: works (M~=9700M; T~=140h)
# bs = 1: works (M~=5500M; T also ~140h?)

# Try using smaller seq length (same as gpt2-small) to make it fit into memory
